...
var ScalarProperty = function (_Property) {
  _inherits(ScalarProperty, _Property);

  function ScalarProperty() {
    _classCallCheck(this, ScalarProperty);

    return _possibleConstructorReturn(this, (ScalarProperty.__proto__ || Object.getPrototypeOf(ScalarProperty)).apply(this, arguments));
  }

  _createClass(ScalarProperty, [{
    key: 'get',
